...
//                realm.beginTransaction()
        ...
        data.add(NewsBean(1, "Business title", "sub", "RJ", "2021/8/21", "10:27:01",  2,1))
        ...
        data.add(NewsBean(11, "Business title", "sub", "RJ", "2021/9/1", "10:27:01",  2,1))
        data.add(NewsBean(12, "Entertainment title", "sub", "C. W. Shin", "2021/9/1", "10:27:01",  4,2))
        data.add(NewsBean(13, "Science title", "sub", "Mike Chen", "2021/9/1", "10:27:01",  9,3))
        data.add(NewsBean(14, "Crime title", "sub", "Murakami Haruki", "2021/9/1", "10:27:01",  1,1))
        data.add(NewsBean(15, "Crime title", "sub", "Lawrence Wright", "2021/9/1", "10:27:01",  1,5))
        data.add(NewsBean(16, "Religion title", "sub", "Henry Parson", "2021/9/1", "10:27:01",  8,5))
        data.add(NewsBean(17, "Health title", "sub", "Yoko Ono", "2021/9/1", "10:27:01",  6,5))
        data.add(NewsBean(18, "Family title", "sub", "John Lennon", "2021/9/1", "10:27:01",  5,2))
        data.add(NewsBean(19, "Religion title", "sub", "Sex Pistol", "2021/9/1", "10:27:01",  8,3))
        data.add(NewsBean(20, "Health title", "sub", "London Calling", "2021/9/1", "10:27:01",  6,1))
